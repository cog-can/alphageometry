...
const_pointnames = "abbc"
const_point_args = g.names2points(const_pointnames)
const_point_args.extend([3, 4])
print(const_point_args)
g.add_eqrat_const(const_point_args, pr.EmptyDependency(0, 'rconst'))
